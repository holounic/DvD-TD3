...
class Critic(nn.Module):
    def __init__(self, state_dim, action_dim, hid_size1=400, hid_size2=300, init_layers=False):
        ...
        self.fc1_1 = nn.Linear(state_dim, hid_size1)
        self.fc2_1 = nn.Linear(hid_size1 + action_dim, hid_size2)
        self.fc3_1 = nn.Linear(hid_size2, 1)

        self.fc1_2 = nn.Linear(state_dim, hid_size1)
        self.fc2_2 = nn.Linear(hid_size1 + action_dim, hid_size2)
